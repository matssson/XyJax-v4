...
export class Parsers {
  ...
  static commit(/*lazy*/ p) {
    return new Parser(function (input) {
      var res = p()(input);
      return new Matcher()
        .Case(Success, function (x) {
          return res;
        })
        .Case(ParseError, function (x) {
          return res;
        })
  ...
  static rep(/*lazy*/ p) {
    ...
    return Parsers.rep1(p).or(function () {
      return s;
    });
  }
  ...
  static repsep(/*lazy*/ p, /*lazy*/ q) {
    var s = Parsers.success(List.empty);
    return Parsers.rep1sep(p, q).or(function () {
      return s;
    });
  }
  ...
  static chainr1(/*lazy*/ p, /*lazy*/ q, combine, first) {
    return p()
      ...
      .to(function (res) {
        return new List.Cons(new Pair(combine, res.head), res.tail).foldRight(
          first,
          function (fa, b) {
...
class Parser {
  ...
  ret(/*lazy*/ v) {
    var self = this;
    return new Parser(function (input) {
      return self.apply(input).map(function (x) {
        return v();
      });
    }).named(this.toString() + "^^^");
  }
