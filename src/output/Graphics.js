...
class World extends Svg {
  ...
  setHeight(height) {
    this.xypicWrapper.setStyle(
      this.svg,
      "height",
      XypicGlobalContext.measure.Em(height),
    );
  }
  ...
  setWidth(width) {
    this.xypicWrapper.setStyle(
      this.svg,
      "width",
      XypicGlobalContext.measure.Em(width),
    );
  }
...
class Transform {
  ...
  translate(x, y) {
    return new Transform(this.transform.append(new Translate(x, y)));
  }
  ...
  rotateRadian(radian) {
    return new Transform(this.transform.append(new Rotate(radian)));
  }
...
class Translate {
  ...
  toTranslateForm() {
    return (
      "translate(" +
      XypicGlobalContext.measure.em2px(this.dx) +
      "," +
      XypicGlobalContext.measure.em2px(-this.dy) +
      ") "
    );
  }
}
