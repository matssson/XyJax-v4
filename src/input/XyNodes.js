...
AST.xypic.includegraphics = class AST_xypic_includegraphics extends (
  BaseXyMmlNode
) {
  constructor(mmlFactory, properties, textMmls) {
    super(mmlFactory, properties, textMmls);
...
AST.ObjectBox.Txt.Width.Vector = class AST_ObjectBox_Txt_Width_Vector extends (
  AST.ObjectBox
) {
  constructor(vector) {
    super();
...
AST.ObjectBox.Txt.Width.Default = class AST_ObjectBox_Txt_Width_Default extends (
  AST.ObjectBox
) {
  constructor() {
    super();
...
AST.ObjectBox.WrapUpObject = class AST_ObjectBox_WrapUpObject extends (
  AST.ObjectBox
) {
  constructor(object) {
    super();
...
AST.ObjectBox.CompositeObject = class AST_ObjectBox_CompositeObject extends (
  AST.ObjectBox
) {
  constructor(objects) {
    super();
...
// <modifier> ::= '!'
AST.Modifier.RestoreOriginalRefPoint = class AST_Modifier_RestoreOriginalRefPoint extends (
  AST.Modifier
) {
  constructor() {
    super();
...
AST.Modifier.Shape.Alphabets = class AST_Modifier_Shape_Alphabets extends (
  AST.Modifier
) {
...
AST.Modifier.Shape.DefineShape = class AST_Modifier_Shape_DefineShape extends (
  AST.Modifier
) {
  constructor(shape) {
    super();
...
AST.Modifier.Shape.Circle = class AST_Modifier_Shape_Circle extends (
  AST.Modifier
) {
  constructor() {
    super();
...
AST.Modifier.Shape.ChangeColor = class AST_Modifier_Shape_ChangeColor extends (
  AST.Modifier
) {
...
// ユーザ定義されたshape
AST.Modifier.Shape.CompositeModifiers = class AST_Modifier_Shape_CompositeModifiers extends (
  AST.Modifier
) {
  /**
...
AST.Command.Path.Label.Above = class AST_Command_Path_Label_Above extends (
  AST.Command.Path.Label
) {
  constructor(anchor, it, aliasOption) {
...
AST.Command.Path.Label.Below = class AST_Command_Path_Label_Below extends (
  AST.Command.Path.Label
) {
  constructor(anchor, it, aliasOption) {
    super(anchor, it, aliasOption);
...
// <label> ::= '|' <anchor> <it> <alias>?
AST.Command.Path.Label.At = class AST_Command_Path_Label_At extends (
  AST.Command.Path.Label
) {
  constructor(anchor, it, aliasOption) {
    super(anchor, it, aliasOption);
...
// <variant> ::= /[^_0123]/ | <empty>
AST.Command.Ar.Form.BuildArrow = class AST_Command_Ar_Form_BuildArrow extends (
  AST.Command.Ar.Form
) {
  /**
...
// <arrow_form> ::= '@' <variant>
AST.Command.Ar.Form.ChangeVariant = class AST_Command_Ar_Form_ChangeVariant extends (
  AST.Command.Ar.Form
) {
  /**
   * @param {String} variant variant
...
AST.Command.Xymatrix.Setup.ChangeSpacing.Row = class AST_Command_Xymatrix_Setup_ChangeSpacing_Row extends (
  AST.Command.Xymatrix.Setup.ChangeSpacing
) {
  constructor(addop, dimen) {
    super(addop, dimen);
  }
...
AST.Command.Xymatrix.Setup.ChangeSpacing.Column = class AST_Command_Xymatrix_Setup_ChangeSpacing_Column extends (
  AST.Command.Xymatrix.Setup.ChangeSpacing
) {
  constructor(addop, dimen) {
    super(addop, dimen);
...
AST.Command.Xymatrix.Setup.ChangeSpacing.RowAndColumn = class AST_Command_Xymatrix_Setup_ChangeSpacing_RowAndColumn extends (
  AST.Command.Xymatrix.Setup.ChangeSpacing
) {
  constructor(addop, dimen) {
    super(addop, dimen);
...
AST.Command.Xymatrix.Setup.PretendEntrySize.Height = class AST_Command_Xymatrix_Setup_PretendEntrySize_Height extends (
  AST.Command.Xymatrix.Setup.PretendEntrySize
) {
  constructor(dimen) {
    super(dimen);
  }
...
AST.Command.Xymatrix.Setup.PretendEntrySize.Width = class AST_Command_Xymatrix_Setup_PretendEntrySize_Width extends (
  AST.Command.Xymatrix.Setup.PretendEntrySize
) {
  constructor(dimen) {
    super(dimen);
...
AST.Command.Xymatrix.Setup.PretendEntrySize.HeightAndWidth = class AST_Command_Xymatrix_Setup_PretendEntrySize_HeightAndWidth extends (
  AST.Command.Xymatrix.Setup.PretendEntrySize
) {
  constructor(dimen) {
    super(dimen);
...
AST.Command.Xymatrix.Setup.FixGrid.Row = class AST_Command_Xymatrix_Setup_FixGrid_Row extends (
  AST.Command.Xymatrix.Setup.FixGrid
) {
  constructor() {
    super();
  }
...
AST.Command.Xymatrix.Setup.FixGrid.Column = class AST_Command_Xymatrix_Setup_FixGrid_Column extends (
  AST.Command.Xymatrix.Setup.FixGrid
) {
  constructor() {
    super();
...
AST.Command.Xymatrix.Setup.FixGrid.RowAndColumn = class AST_Command_Xymatrix_Setup_FixGrid_RowAndColumn extends (
  AST.Command.Xymatrix.Setup.FixGrid
) {
  constructor() {
    super();
...
AST.Command.Xymatrix.Setup.AdjustEntrySize.Margin = class AST_Command_Xymatrix_Setup_AdjustEntrySize_Margin extends (
  AST.Command.Xymatrix.Setup.AdjustEntrySize
) {
  constructor(addop, dimen) {
    super(addop, dimen);
  }
...
AST.Command.Xymatrix.Setup.AdjustEntrySize.Width = class AST_Command_Xymatrix_Setup_AdjustEntrySize_Width extends (
  AST.Command.Xymatrix.Setup.AdjustEntrySize
) {
  constructor(addop, dimen) {
    super(addop, dimen);
...
AST.Command.Xymatrix.Setup.AdjustEntrySize.Height = class AST_Command_Xymatrix_Setup_AdjustEntrySize_Height extends (
  AST.Command.Xymatrix.Setup.AdjustEntrySize
) {
  constructor(addop, dimen) {
    super(addop, dimen);
...
AST.Command.Xymatrix.Entry.SimpleEntry = class AST_Command_Xymatrix_Entry_SimpleEntry extends (
...
AST.Command.Xymatrix.Entry.ObjectEntry = class AST_Command_Xymatrix_Entry_ObjectEntry extends (
  AST.Command.Xymatrix.Entry
) {
  /**
...
AST.Command.Xymatrix.Entry.EmptyEntry = class AST_Command_Xymatrix_Entry_EmptyEntry extends (
  AST.Command.Xymatrix.Entry
) {
  /**
   * @param {AST.Decor} decor decoration
...
AST.Command.Twocell.Twocell = class AST_Command_Twocell_Twocell extends (
  AST.Command.Twocell.Hops2cell
) {
  constructor(hops, maybeDisplace) {
...
AST.Command.Twocell.UpperTwocell = class AST_Command_Twocell_UpperTwocell extends (
  AST.Command.Twocell.Hops2cell
) {
  constructor(hops, maybeDisplace) {
    super(hops, maybeDisplace);
  ...
  toString() {
    return (
      "\\xuppertwocell[" + this.hops + "]" + this.maybeDisplace.getOrElse("{}")
    );
  }
};
//           |   '\' /[lrud]+/ 'lowertwocell'
//           |   '\xlowertwocell' '[' /[lrud]+/ ']' '{' <text> '}'
AST.Command.Twocell.LowerTwocell = class AST_Command_Twocell_LowerTwocell extends (
  AST.Command.Twocell.Hops2cell
) {
  constructor(hops, maybeDisplace) {
    super(hops, maybeDisplace);
  ...
  toString() {
    return (
      "\\xlowertwocell[" + this.hops + "]" + this.maybeDisplace.getOrElse("{}")
    );
  }
};
//           |   '\' /[lrud]+/ 'compositemap'
//           |   '\xcompositemap' '[' /[lrud]+/ ']' '{' <text> '}'
AST.Command.Twocell.CompositeMap = class AST_Command_Twocell_CompositeMap extends (
  AST.Command.Twocell.Hops2cell
) {
  constructor(hops, maybeDisplace) {
    super(hops, maybeDisplace);
  ...
  toString() {
    return (
      "\\xcompositemap[" + this.hops + "]" + this.maybeDisplace.getOrElse("{}")
    );
  }
};
...
AST.Command.Twocell.Nudge.Number = class AST_Command_Twocell_Nudge_Number extends (
  AST.Command.Twocell.Nudge
) {
  /**
...
AST.Command.Twocell.Nudge.Omit = class AST_Command_Twocell_Nudge_Omit extends (
  AST.Command.Twocell.Nudge
) {
  constructor() {
    super();
...
AST.Command.Twocell.Arrow.WithOrientation = class AST_Command_Twocell_Arrow_WithOrientation extends (
  AST.Command.Twocell.Arrow
) {
  /**
   * @param {String} tok
   * @param {AST.Object} labelObject
...
AST.Command.Twocell.Arrow.WithPosition = class AST_Command_Twocell_Arrow_WithPosition extends (
  AST.Command.Twocell.Arrow
) {
  /**
   * @param {AST.Command.Twocell.Nudge.*} nudge
...
AST.Pos.Xyimport.TeXCommand = class AST_Pos_Xyimport_TeXCommand extends (
  AST.Pos.Xyimport
) {
  /**
...
AST.Pos.Xyimport.Graphics = class AST_Pos_Xyimport_Graphics extends (
  AST.Pos.Xyimport
) {
  /**
   * @param {Number} width the width of the graphics in the coordinate system
...
AST.Command.Includegraphics.Attr.Width = class AST_Command_Includegraphics_Attr_Width extends (
  AST.Command.Includegraphics.Attr
) {
  /**
   * @param {String} dimen
   */
...
AST.Command.Includegraphics.Attr.Height = class AST_Command_Includegraphics_Attr_Height extends (
  AST.Command.Includegraphics.Attr
) {
  /**
   * @param {String} dimen
